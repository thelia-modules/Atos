...
return array(
    ...
    'Maximum order total in the default currency for which the multiple times payment method is available. Enter 0 for no maximum' => 'Montant maximum dans la devise par défaut pour proposer ce moyen de paiement. Laisser 0 pour ne pas fixer de maximum.',
    ...
    'Minimum order total in the default currency for which the multiple times payment method is available. Enter 0 for no minimum' => 'Montant minimum dans la devise par défaut pour proposer ce moyen de paiement. Laisser 0 pour ne pas fixer de minimum.',
    ...
    'Number of installements. Should be more than one' => 'Nombre de mensualités proposé. Doit être supérieur à 1',
